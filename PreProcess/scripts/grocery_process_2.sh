#!/usr/bin/env bash
# -------------------------------------------------------------
# One-click script to execute the Grocery prompt-construction notebook.
# Prerequisite: grocery_process_1.sh has already produced files in
#   PreProcess/output/grocery/
# Usage (after cd PreProcess):
#   bash scripts/grocery_process_2.sh
# -------------------------------------------------------------
set -e
...
NOTEBOOK_PATH="filter/grocery/prompt_process.ipynb"
...
echo "\n✅ prompt_process_grocery.ipynb executed successfully."
